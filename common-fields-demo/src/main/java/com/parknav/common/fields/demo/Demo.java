package com.parknav.common.fields.demo;
...
import com.parknav.common.fields.demo.model.marina.MarinaDetailsDisplay;
import com.parknav.common.fields.demo.model.marina.MarinaEditor;
import com.parknav.common.fields.demo.model.marina.MarinaNameDisplay;
...
import com.parknav.common.fields.demo.model.person.PersonBatcherBase;
import com.parknav.common.fields.demo.model.person.PersonDemoAsyncService;
import com.parknav.common.fields.demo.model.person.PersonDisplay;
import com.parknav.common.fields.jackson.FieldPropertyFilter;
import com.parknav.common.fields.jackson.FieldsSerializerModifier;
...
import com.parknav.common.fields.demo.model.person.Notifier;
...
public class Demo {
	...
	private void batcher() throws IOException, InterruptedException {
		...
		/*FieldsRequest request1 = */batcher.get(personId, graph1, new FieldsServiceHandler<>() {
			@Override
			public void onPreRequest(FieldsRequest request) {
		...
		/*FieldsRequest request2 = */batcher.get(personId, graph2, new FieldsServiceHandler<>() {
			@Override
			public void onPreRequest(FieldsRequest request) {
