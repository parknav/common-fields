...
public interface HasFields<C extends HasFields<C, F>, F extends Enum<F> & FieldEnum> {
	...
	*/
	 ...
	 * If graph consistency is required, consider {@link HasEntityFields#extend(FieldGraph, com.steatoda.commons.fields.service.FieldsService)}-ing object immediately
